"""
Django settings for carpoolr project.
...
SECRET_KEY = 'django-insecure-=^em*20i%#(p5*-gq96x)5f^yj#l6d8&)th=mxiwv#&4f4=6i!'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'rides.context_processors.pending_requests_count',
            ],
        },
    },
]

WSGI_APPLICATION = 'carpoolr.wsgi.application'
